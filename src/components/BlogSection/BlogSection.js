              ...
              <div className={`blogBlock ${blog.styleClass} mb-60`}>
                ...
                <div className="blogBlock__content">
                  <div className="blogBlock__header">
                    <span className="blogBlock__tag tag mb-20">
                      {blog.thumb}
                    </span>
                  ...
                  <div className="blogBlock__body mb-30">
                    <p className="blogBlock__text text">{blog.description}</p>
                  </div>
                  <div className="blogBlock__meta">
                    <ul className="blogBlock__meta__list">
                      <li>
                        ...
                        >
                          <img
                            className="blogBlock__metaUser__thumb"
                            src={blog.authorImg}
                            alt="Gainioz User"
                          />
                          <span className="blogBlock__metaUser__name">
                            {blog.author}
                          </span>
                        </Link>
                      </li>
                      <li>
                        <button className="blogBlock__reactButton">
                          <span className="blogBlock__reactButton__count">
                            {blog.comment}
                          </span>
                        </button>
                      </li>
                      <li>
                        <div className="blogBlock__date">
                          <span className="blogBlock__date__text">
                            {blog.create_at}
                          </span>
